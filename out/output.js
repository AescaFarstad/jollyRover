...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5337760,
    DYNAMIC_BASE = 5337760,
    DYNAMICTOP_PTR = 94624;
...
// STATICTOP = STATIC_BASE + 93856;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { __GLOBAL__sub_I_Global_cpp() } }, { func: function() { __GLOBAL__sub_I_base64_2_cpp() } }, { func: function() { __GLOBAL__sub_I_SystemInfo_cpp() } }, { func: function() { ___emscripten_environ_constructor() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
...
var STATIC_BUMP = 93856;
Module["STATIC_BASE"] = STATIC_BASE;
Module["STATIC_BUMP"] = STATIC_BUMP;

/* no memory initializer */
var tempDoublePtr = 94864
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=94672;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
...
var real___GLOBAL__sub_I_SystemInfo_cpp = asm["__GLOBAL__sub_I_SystemInfo_cpp"]; asm["__GLOBAL__sub_I_SystemInfo_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_SystemInfo_cpp.apply(null, arguments);
};

var real___GLOBAL__sub_I_base64_2_cpp = asm["__GLOBAL__sub_I_base64_2_cpp"]; asm["__GLOBAL__sub_I_base64_2_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_base64_2_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_SystemInfo_cpp = Module["__GLOBAL__sub_I_SystemInfo_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_SystemInfo_cpp"].apply(null, arguments) };
var __GLOBAL__sub_I_base64_2_cpp = Module["__GLOBAL__sub_I_base64_2_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_base64_2_cpp"].apply(null, arguments) };
